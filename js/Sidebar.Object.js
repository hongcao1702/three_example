...
Sidebar.Object = function ( editor ) {
	...
	var objectUUID = new UI.Input().setWidth( '150px' ).setFontSize( '12px' ).setDisabled( true );
    ...
    var objectRotationX = new UI.Number().setStep( 10 ).setWidth( '50px' ).onChange( update );
    var objectRotationY = new UI.Number().setStep( 10 ).setWidth( '50px' ).onChange( update );
    var objectRotationZ = new UI.Number().setStep( 10 ).setWidth( '50px' ).onChange( update );
    ...
    /** 设置gravity**/
    var objectGravityRow = new UI.Row();
    var objectGravity = new UI.Checkbox().onChange( update );

    objectGravityRow.add( new UI.Text( 'Gravity' ).setWidth( '90px' ) );
    objectGravityRow.add( objectGravity );

    container.add( objectGravityRow );
	...
	function update() {
		...
		if ( object !== null ) {
            ...
            /** 设置gravity**/
			if((object.gravity !== undefined) && (object.gravity !==  objectGravity.getValue())) {

                editor.execute( new SetValueCommand( object, 'gravity', objectGravity.getValue() ) );
	...
	function updateUI( object ) {
        ...
        if(object.gravity !== undefined) {
            objectGravity.setValue( object.gravity );
		}
